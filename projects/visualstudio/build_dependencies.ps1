...
param([string]$FightLibPath="", [string]$Config = "Debug", [string]$Platform = "Win32", [string]$PlatformToolset = "v140")
...
& "$msbuild_path" /t:Box2D "$b2d_path\Box2D.sln" "/p:PlatformToolset=$PlatformToolset" "/p:Configuration=$Config" "/p:Platform=$Platform"
