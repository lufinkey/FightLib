...
namespace fl
{
	...
	{
	public:
		PixelCollisionRect(const fgl::String& tag, const fgl::RectangleD& dstRect, const fgl::RectangleD& lastRect, const fgl::RectangleU srcRect, fgl::TextureImage* image, bool mirroredHorizontal, bool mirroredVertical);
		PixelCollisionRect(const fgl::String& tag, const fgl::RectangleD& dstRect, const fgl::RectangleD& lastRect, const fgl::RectangleU srcRect, double rotation, const fgl::Vector2d& origin, fgl::TextureImage* image, bool mirroredHorizontal, bool mirroredVertical);

		virtual fgl::RectangleD getRect() const override;
		virtual fgl::RectangleD getPreviousRect() const override;
